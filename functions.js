...
var correct2 = function()
{
  ...
  document.getElementById("feedback2").style.color = "#6b8e23";
  document.getElementById("q2buttonT").disabled = true;
  document.getElementById("q2buttonF").disabled = true;
  document.getElementById("q3buttonT").disabled = false;
  document.getElementById("q3buttonF").disabled = false;
}
...
var correct3 = function()
{
  ...
  document.getElementById("q4buttonF").disabled = false;
}
...
var correct4 = function()
{
  ...
  document.getElementById("feedback4").style.color = "#6b8e23";
  document.getElementById("q4buttonT").disabled = true;
  document.getElementById("q4buttonF").disabled = true;
  document.getElementById("q5buttonT").disabled = false;
  document.getElementById("q5buttonF").disabled = false;
}
...
var correct5 = function()
{
  ...
  document.getElementById("feedback5").style.color = "#6b8e23";
  document.getElementById("q5buttonT").disabled = true;
  document.getElementById("q5buttonF").disabled = true;
}
